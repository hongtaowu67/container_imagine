...
numJoints = p.getNumJoints(robotID) # The robot has 18 joints (including the gripper)
print('Number of joint:{}'.format(numJoints))
# Get Robot Joint Information
jointInfoList = [p.getJointInfo(robotID, jointID) for jointID in range(numJoints)]
