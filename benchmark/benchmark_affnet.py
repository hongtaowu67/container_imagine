"""
Benchmarking the result from the containability imagination with object name.
Will deprecate in the end and being replaced by benchmarking with human annotation.

For affnet restricted dataset
