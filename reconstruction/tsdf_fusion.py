...
def run_tsdf_fusion_cuda(tsdf_fusion_dir, image_folder, camera_intrinsics_file, output_dir=None, voxel_grid_origin_x=-1.5,
    voxel_grid_origin_y=-1.5, voxel_grid_origin_z=-0.5, voxel_size=0.006,
...
if __name__ == "__main__":
    ...
    image_folder = os.path.join(tsdf_fusion_dir, "data/rgbd-frames")
    camera_intrinsics_file = os.path.join(tsdf_fusion_dir, "data/camera-intrinsics.txt")
    ...
    tsdf_mesh_filename = os.path.join(tsdf_fusion_dir, 'model/test_1110_1.ply')
