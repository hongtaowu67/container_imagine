...
class Calibrate(object):
    ...
    def __init__(self, tcp_host_ip='172.22.22.2', save_dir=None):
        ...
        """
        rospy.loginfo("Make sure to roslaunch openni2_launch openni2.launch before running this code!")
...
if __name__ == "__main__":
    ...
    parser.add_argument("save_dir", type=str, help="directory to save calibration data")
    parser.add_argument("tcp_host_ip", type=str, default="172.22.22.2", help="tcp address of the robot")
