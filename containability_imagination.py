...
result_dir = "/home/hongtao/Dropbox/ICRA2021/benchmark/test_set_all_imgn_w_tran_0703"
...
for obj_name in obj_list:
    ...
    C = Containability(obj_urdf, obj_vhacd_mesh, rotate=False, translate=True, obj_zero_pos=[0, 0, 1], 
        obj_zero_orn=[0, 0, 0], check_process=False, mp4_dir=None, object_name=None, content_urdf=content_urdf)
