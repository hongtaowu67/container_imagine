...
obj_dir = "/home/hongtao/Dropbox/ICRA2021/data/training_set"
result_dir = "/home/hongtao/Dropbox/ICRA2021/benchmark/training_set_containability_w_everything_0805"
...
result_dir = "/home/hongtao/Dropbox/ICRA2021/affnet_benchmark/affnet_benchmark_imgn_containability"
...
for class_name  in class_list:
    ...
    obj_list = os.listdir(class_dir)
    for obj_name in obj_list:
        start_time = time.time()
        obj_urdf = os.path.join(class_dir, obj_name, obj_name + "_mesh_0.urdf")
        obj_vhacd_mesh = os.path.join(class_dir, obj_name, obj_name + "_mesh_0_vhacd.obj")
